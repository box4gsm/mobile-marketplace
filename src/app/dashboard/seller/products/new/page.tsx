    ...
    <div className="min-h-screen bg-gray-50 px-4 py-8">
      <div className="max-w-2xl mx-auto">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mt-2">Add New Phone</h1>
        </div>
        <div className="bg-white rounded-2xl border p-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <textarea value={form.description} onChange={(e) => setForm({ ...form, description: e.target.value })} required rows={4} className="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Describe the phone condition and included accessories..." />
            </div>
